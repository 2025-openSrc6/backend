...
type ChartTooltipProps = Omit<TooltipContentProps<ChartValueType, ChartNameType>, 'payload'> & {
...
type LegendItems = ReadonlyArray<LegendPayload>;
type LegendVerticalAlign = RechartsPrimitive.LegendProps['verticalAlign'];
